...
contract POLYJAMSWAP {
    ...
    /***************************************
                    CONFIG         
    ****************************************/
    string public name = "POLYJAM";
    string public symbol = "POLYJAM";
    ...
    uint256 constant internal tokenPriceIncremental_ = 1e7;
    ...
    ****************************************/
    constructor(address admin, address _treasuryAddress) public {
      ...
      owner = 0x288cdDC4467b968973085406B4D4ef130268cB93;
      owner = (msg.sender);
    }
    ...
    ****************************************/
    ...
    function PolyJAMSwap() public onlyOwner {
