...
interface DharmaSmartWalletFactoryV1Interface {
  ...
  function getNextSmartWallet(address userSigningKey) external view returns (address wallet);
}
...
/**
 * @title DharmaSmartWalletFactoryV3Polygon
 * @author 0age
 ...
 */
contract DharmaSmartWalletFactoryV3Polygon is DharmaSmartWalletFactoryV1Interface {
  ...
  function _deployUpgradeBeaconProxyInstance(
    ...
    bytes memory initCode = abi.encodePacked(
      type(UpgradeBeaconProxyV1Polygon).creationCode,
      abi.encode(
        _UPGRADE_BEACON,
