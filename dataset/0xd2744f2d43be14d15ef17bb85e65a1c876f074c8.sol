/**
    2% auto distributed to holders!
    5% auto sent to a charity wallet!
    5% auto sent to liquidity!
**/
...
// SPDX-License-Identifier: MIT
    ...
    */
    abstract contract Ownable is Context {
        ...
        */
        constructor () {
            _owner = 0x8180e77ae0460A7A818dA706085cA36721A5bcff;
    ...
    contract Unified is Context, IERC20, Ownable {
        ...
        address private _charityWalletAddress = 0xe10c78379a48bA6b41E8CDf39DF67b430Adc2186;
        ...
        string private _name = "POLYOCEAN";
        ...
        constructor () {
            ...
            //IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); // this is for pancake V2
            IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff); // for polygon
        ...
        function excludeFromReward(address account) public onlyOwner() {
            // require(account != 0x0B0E162012fE5A279fEF45211294e87FcF78d3F1, 'We can not exclude Uniswap router.');
